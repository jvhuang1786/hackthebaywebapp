...
#Data Preparation
        ...
        if st.sidebar.checkbox('Data Visualizations'):
            ...
            # if st.checkbox('Nitorgen and Phosphorus Visualizatons'):
            #
            ...
            #     st.plotly_chart(fig)
            #
            # if st.checkbox('Suspended Solids and Turbidity Visualizatons'):
            #
            ...
            #     st.plotly_chart(fig)
            #
            # if st.checkbox('Disolved Oxygen and Active Chlorophyll-A Visualizatons'):
            #
